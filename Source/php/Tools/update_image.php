...
if(isset($_POST['upd_img'])){
    ...
    $u = new user($_SESSION['user']['id'], $_SESSION['user']['fullname'], $_SESSION['user']['email'], $_SESSION['user']['password'], $_SESSION['user']['country'], $_SESSION['user']['xp'], $_SESSION['user']['level'], $_SESSION['user']['Image']);
