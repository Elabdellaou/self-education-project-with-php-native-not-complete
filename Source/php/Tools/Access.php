...
if (!isset($_SESSION['user']) || !isset($_SESSION['login']) || $_SESSION['login'] == false)
    ...
    $u = new user($_SESSION['user']['id'], $_SESSION['user']['name'], $_SESSION['user']['email'], $pass, $_SESSION['user']['country'], $_SESSION['user']['xp'], $_SESSION['user']['level'], $_SESSION['user']['image']);
}
